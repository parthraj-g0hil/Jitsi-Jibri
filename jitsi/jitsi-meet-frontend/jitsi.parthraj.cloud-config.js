...
var config = {
    hiddenDomain: 'recorder.jitsi.parthraj.cloud',
    enableRecording: true,

    // Enable server-side Jibri recording
    ...
    hosts: {
        // XMPP domain.
        domain: 'jitsi.parthraj.cloud',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'jitsi.parthraj.cloud',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.jitsi.parthraj.cloud',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'jitsi.parthraj.cloud',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://jitsi.parthraj.cloud/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    websocket: 'wss://jitsi.parthraj.cloud/' + subdir + 'xmpp-websocket',

    // websocketKeepAliveUrl: 'https://jitsi.parthraj.cloud/' + subdir + '_unlock',
    ...
    // focusUserJid: 'focus@auth.jitsi.parthraj.cloud',

    // Option to send conference requests to jicofo over http (requires nginx rule for it)
    // conferenceRequestUrl:
    //   'https://<!--# echo var="http_host" default="jitsi.parthraj.cloud" -->/' + subdir + 'conference-request/v1',
    ...
    //     // by default uses:
    //     // 'https://jitsi.parthraj.cloud/static/oauth.html'
    //     redirectURI:
    //          'https://jitsi.parthraj.cloud/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:jitsi.parthraj.cloud:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.jitsi.parthraj.cloud',
